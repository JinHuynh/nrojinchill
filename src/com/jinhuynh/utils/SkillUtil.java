...
//        Skill skill = null;
//        try {
//            skill = nClassLH.getSkillTemplate(tempId).skillss.get(level - 1);
//        } catch (Exception e) {
//            try {
//                skill = nClassLH.getSkillTemplate(tempId).skillss.get(level - 1);
//            } catch (Exception ex) {
...
//    }
    ...
    public static byte getTempSkillSkillByItemID(int id) {
        ...
        } else if (id >= 2089 && id <= 2089) {
            return Skill.SUPER_KAME;
        } else if (id >= 2090 && id <= 2090) {
            return Skill.MA_PHONG_BA;
        } else if (id >= 2091 && id <= 2091) {

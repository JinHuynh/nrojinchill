package com.jinhuynh.models.shop;
...
import com.jinhuynh.services.func.Trade;
        ...
        if (InventoryServiceNew.gI().getCountEmptyBag(player) == 0) {
         ...
         Item sushi = InventoryServiceNew.gI().findItemBag(player, 667);
              ...
              ThucAn = player.inventory.itemsBag.stream().filter(itemm -> itemm.isNotNullItem() && itemm.isThucAn() && itemm.quantity >= 99).findFirst().get();
               ...
               if (player.zone.map.mapId == 48 && shop.tagName.contains("THUCANHUYDIET")) {
                   if(ThucAn == null) {

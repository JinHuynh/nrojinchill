...
//    }
    ...
    private void increasePoint() {
        if (this.nPoint != null && Util.canDoWithTime(lastTimeIncreasePoint, 1)) {
                ...
                byte type = (byte) Util.nextInt(0, 10);
                short point = (short) Util.nextInt(100);
...
//    }
    ...
    public void transform() {// bien hinh
        if (this.typePet == 1) {
        ...
        if (this.typePet == 4) {
         ...
         if (this.typePet == 5) {
            this.isTransform = !this.isTransform;
            Service.gI().Send_Caitrang(this);
            Service.gI().chat(this, "GokuSS4");
        }
        if (this.typePet == 6) {
            this.isTransform = !this.isTransform;
            Service.gI().Send_Caitrang(this);
            Service.gI().chat(this, "Heart");
        }
         if (this.typePet == 7) {
            this.isTransform = !this.isTransform;
            Service.gI().Send_Caitrang(this);
            Service.gI().chat(this, "Gojo");
        }
        if (this.typePet == 8) {
            this.isTransform = !this.isTransform;
            Service.gI().Send_Caitrang(this);
            Service.gI().chat(this, "Gokuvocuc");
        }
    }
    ...
    private void startSkillSpecialID25(Pet aThis) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    private void sendEffSkillSpecialID25(Pet aThis) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
}

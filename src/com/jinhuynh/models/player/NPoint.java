...
public class NPoint {
        ...
        for (Item item : this.player.inventory.itemsBody) {
         ...
         if (this.player.isPl() && this.player.fusion.typeFusion == ConstPlayer.HOP_THE_PORATA3) {
            for (Item item : this.player.inventory.itemsBag) {
                if (item.isNotNullItem() && item.template.id == 2095) {
                    for (Item.ItemOption io : item.itemOptions) {
                        switch (io.optionTemplate.id) {
                            case 14: // Chí mạng+#%
                                this.critAdd += io.param;
    ...
    private void setHpMax() {
        ...
        else if (this.player.setClothes.NguyetAn == 5 || this.player.setClothes.nappa == 5) {
            this.hpMax += ((long) this.hpMax * 180 / 100);
        }
        // ngọc rồng đen 1 sao
...
//        }//bánh tét
    ...
    private void setMpMax() {
        ...
        if (this.player.setClothes.NguyetAn == 5) {
         ...
         else if (this.player.setClothes.NguyetAn == 5 || this.player.setClothes.picolo == 5) {
           this.mpMax *= 4;
        }
        // pet mabư
        if (this.player.isPet && ((Pet) this.player).typePet == 1
    ...
    public int getDameAttack(boolean isAttackMob) {
        ...
        switch (skillSelect.template.id) {
            ...
            dameAttack += dameAttack*5/10;
                  ...
                  else if (this.player.setClothes.NhatAn == 5 || this.player.setClothes.songoku == 5) {
            dameAttack += dameAttack*13/10;
        }
            ...
            dameAttack += dameAttack*7/10;
                  ...
                  else if (this.player.setClothes.NhatAn == 5 || this.player.setClothes.kirin == 5) {
            dameAttack += dameAttack*15/10;
        }
                break;
            ...
            dameAttack += dameAttack*7/10;
                ...
                else if (this.player.setClothes.NhatAn == 5 || this.player.setClothes.ocTieu == 5) {
            dameAttack += dameAttack*15/10;
        }
                break;

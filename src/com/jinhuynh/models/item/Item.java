package com.jinhuynh.models.item;

import com.jinhuynh.models.Template;
import com.jinhuynh.models.Template.ItemTemplate;
...
//        this.itemOptions = _item.itemOptions;
    ...
    public boolean isTrangBiHacHoa() {
        ...
        if (this.template.type == 11 || this.template.type == 27 || this.template.type == 72) {
            return true;
        }

        return false;
    }
    public boolean isTrangBiAn1() {

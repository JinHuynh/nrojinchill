...
public class Quylao extends Boss {
    ...
    public Quylao() throws Exception {
        super(BossID.QUYLAO, BossesData.QUY_LAO);
    }

    @Override
   public void reward(Player plKill) {
        int[] itemCt = new int[]{574};
        ...
        if (Util.isTrue(80, 100)) {
            ...
            Service.gI().dropItemMap(this.zone, Util.useItem(zone, itemCt[randomDo], Util.nextInt(1,5), this.location.x, this.location.y, plKill.id));
        } 
    }

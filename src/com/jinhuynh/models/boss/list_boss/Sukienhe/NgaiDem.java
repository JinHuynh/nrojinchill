...
public class NgaiDem extends Boss {
    ...
    public NgaiDem(int bossID, BossData bossData, Zone zone) throws Exception {
    ...
    public void reward(Player plKill) {
        ...
        ItemMap it = new ItemMap(this.zone, 2128, 1, this.location.x, this.zone.map.yPhysicInTop(this.location.x,
    ...
    public int injured(Player plAtt, int damage, boolean piercing, boolean isMobAttack) {
        if (!this.isDie()) {
            if (!piercing && Util.isTrue(35, 100)) {
                this.chat("Xí hụt");
                return 0;
            }

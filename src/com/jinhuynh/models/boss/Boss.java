...
import com.jinhuynh.models.boss.iboss.IBossNew;
import com.jinhuynh.models.boss.iboss.IBossOutfit;
import com.jinhuynh.models.boss.list_boss.NRD.*;
        ...
        if (Util.canDoWithTime(this.lastTimeAttack, 100) && this.typePk == ConstPlayer.PK_ALL) {
            ...
            try {
                ...
                if (Util.getDistance(this, pl) <= this.getRangeCanAttackWithSkillSelect()) {
                    ...
                    SkillService.gI().useSkill(this, pl, null, _msg);
                    checkPlayerDie(pl);
                } else {
                    if (Util.isTrue(1, 2)) {

...
public class ConstNpc {
    ...
    public static final byte NRO_JIN_CHILL = 115;
 ...
 public static final byte NAMI =109;
    //----------------------index menu------------------------------------------
    ...
    //doi qua su kien he
    public static final int SU_KIEN_HE = 526;
    ...
    public static final int MENU_DAP_DO = 507;
     public static final int MENU_DOI_BON_TAM = 509;
      public static final int NANG_CAP_TRANG_BI = 510;
      public static final int NANG_CAP_TRANG_BI1 = 511;
      public static final int NANG_CAP_TRANG_BI2 = 512;
    ...
    public static final int OPEN_GOI_BOSS_SU_KIEN_HE = 532;
    public static final int OPEN_GOI_BOSS_SU_KIEN_HE_1 = 533;
    ...
    public static final int menuxd = 521;
     public static final int settltd = 1200;
    public static final int settlnm = 1201;
    public static final int settlxd = 1202;
     public static final int sethdtd = 1300;
    public static final int sethdnm = 1301;
    public static final int sethdxd = 1302;
     public static final int settstd = 1400;
    public static final int settsnm = 1401;
    public static final int settsxd = 1402;
    ...
    public static final int MENU_OPTION_USE_ITEM2116 = 2116;
        public static final int MENU_OPTION_USE_ITEM2143 = 2143;

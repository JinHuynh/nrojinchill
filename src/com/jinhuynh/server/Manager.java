...
import com.jinhuynh.card.OptionCard;
...
import com.jinhuynh.jdbc.daos.ShopDAO;
import com.jinhuynh.kygui.ItemKyGui;
import com.jinhuynh.kygui.ShopKyGuiManager;
import com.jinhuynh.models.Template.*;
import com.jinhuynh.models.clan.Clan;
import com.jinhuynh.models.clan.ClanMember;
import com.jinhuynh.models.intrinsic.Intrinsic;
import com.jinhuynh.models.item.Item;
import com.jinhuynh.models.map.WayPoint;
...
import com.jinhuynh.models.npc.NpcFactory;
import com.jinhuynh.models.player.Player;
import com.jinhuynh.models.reward.ItemMobReward;
import com.jinhuynh.models.reward.ItemOptionMobReward;
import com.jinhuynh.models.reward.MobReward;
import com.jinhuynh.models.shop.Shop;
import com.jinhuynh.models.skill.NClass;
import com.jinhuynh.models.skill.Skill;
import com.jinhuynh.models.task.SideTaskTemplate;
import com.jinhuynh.models.task.SubTaskMain;
import com.jinhuynh.models.task.TaskMain;
...
//    public static byte RATE_EXP_SERVER = 1;// sau khi chinh
    ...
    public static final List<com.jinhuynh.models.map.Map> MAPS = new ArrayList<>();
    ...
    public static final String queryTopNap = "SELECT p.id, a.tongnap\n"
            ...
            + "LIMIT 10;";
    public static final String queryTopSK16 = "SELECT p.id, a.topsk16\n"
            + "FROM player p\n"
            + "JOIN account a ON p.account_id = a.id\n"
            + "ORDER BY a.topsk16 DESC\n"
            + "LIMIT 10;";
    ...
    public static List<TOP> topsk16;

    public static long timeRealTop = 0;
   public static final short [] itemHD = {650,651,652,653,654,655,656,657,658,659,660,661,662};
    public static final short[] itemIds_TL = {555, 557, 559, 556, 558, 560, 562, 564, 566, 563, 565, 567, 561};
    public static final byte[] itemIds_NR_SB = {16};
    ...
    private void initMap() {
        ...
        for (MapTemplate mapTemp : MAP_TEMPLATES) {
            ...
            com.jinhuynh.models.map.Map map = new com.jinhuynh.models.map.Map(mapTemp.id,
...
//                        System.out.println(item.getQuantity()[0] + "/" + item.getQuantity()[1]);
            ...
            System.out.println("Finish load item ky gui [" + ShopKyGuiManager.gI().listItem.size() + "]!");
...
//                    dataArray.clear();
            ...
            topsk16 = realTop(queryTopSK16, con);
            Logger.success("Load top sk16 thành công (" + topsk16.size() + ")\n");
            topNap = realTop(queryTopNap, con);
            Logger.success("Load top nap thành công (" + topNap.size() + ")\n");
            topSM = realTop(queryTopSM, con);
            Logger.success("Load top nap thành công (" + topSM.size() + ")\n");
            ...
            while (rs.next()) {
                ...
                switch (query) {
                    ...
                    case queryTopNHS:
                        ...
                        break;
                    case queryTopNap:
                        top.setInfo1(rs.getInt("tongnap") + " coin");
                        top.setInfo2(rs.getInt("tongnap") + " coin");
                        break;

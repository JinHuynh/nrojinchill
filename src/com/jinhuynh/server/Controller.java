...
import com.jinhuynh.consts.ConstIgnoreName;
...
import static com.jinhuynh.services.func.Input.CHOOSE_LEVEL_BDKB;
import static com.jinhuynh.services.func.Input.NUMERIC;
...
//    Logger.log(Logger.BLUE,"Phiên bản sử dụng:" + msg.readUTF() + " \n");
    ...
    public void sendInfo(MySession session) {
        ...
        if (TaskService.gI().getIdTask(player) == ConstTask.TASK_0_0) {
            NpcService.gI().createTutorial(player, -1,
                    "Chào mừng " + player.name + " đến với NRO JINCHILL\n"
    ...
    private void sendThongBaoServer(Player player) {
        Service.gI().sendThongBaoFromAdmin(player, "NGỌC RỒNG JINCHILL.\nMáy chủ thử nghiệm !!");
    }

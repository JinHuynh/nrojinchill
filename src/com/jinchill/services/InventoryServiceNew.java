...
import com.jinhuynh.MaQuaTang.MaQuaTang;
...
public class InventoryServiceNew {
 ...
 if ( pudding != null && pudding.quantity >= 98 ||
                                                xucxich != null && xucxich.quantity >= 98||
                                                kemdau != null && kemdau.quantity  >=98||
                                                mily != null && mily.quantity >= 98 ||
                                                sushi !=null && sushi.quantity >= 98){
              ThucAn = player.inventory.itemsBag.stream().filter(itemm -> itemm.isNotNullItem() && itemm.isThucAn() && itemm.quantity >= 99).findFirst().get();
               }
                 ...
                 return false;
                        ...
                        if (item.template.type == (byte) 0) { //AO HUY DIET
                            ...
                            if (bonusHuyDiet > -1) {
                                ...
                                }  InventoryServiceNew.gI().subQuantityItemsBag(player, ThucAn, 80);
                            }
                            ...
                            if (bonusHuyDiet > -1) {
                                for (byte ix = 0; ix < _item.itemOptions.size(); ix++) {
                                    if (_item.itemOptions.get(ix).optionTemplate.id == 22) {
                                            item.itemOptions.get(ix).param += (int) (_item.itemOptions.get(ix).param * bonusHuyDiet / 100);
//                                        item.itemOptions.get(ix).param += (int) Util.nextInt(1, 15);
                                        item.itemOptions.add(new Item.ItemOption(30, 0));
                                        item.itemOptions.add(new Item.ItemOption(21,80));
                                    }
        ...
        if (itemAdd.template.isUpToUp) {
            for (Item it : items) {
                ...
                if (itemAdd.template.id == 457
                        | itemAdd.template.id == 2094
                        | itemAdd.template.id == 933
                        | itemAdd.template.id == 934
                        || itemAdd.template.id == 2044
                        || (itemAdd.template.id >= 443 && itemAdd.template.id <= 447) ||
                        itemAdd.template.id == 673
                        || (itemAdd.template.id >= 220 && itemAdd.template.id <= 225)
                        || (itemAdd.template.id >= 695 && itemAdd.template.id <= 698)
                        || (itemAdd.template.id >= 663 && itemAdd.template.id <= 667)
                        || (itemAdd.template.id >= 2116 && itemAdd.template.id <= 2121)
                        || (itemAdd.template.id >= 2124 && itemAdd.template.id <= 2130)
                        || itemAdd.template.id == 590
                        || itemAdd.template.id == 610
                        || itemAdd.template.type == 14
                        || itemAdd.template.type == 933
                        || itemAdd.template.type == 99) {

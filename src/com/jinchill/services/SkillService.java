...
import com.jinhuynh.models.player.SkillSpecial;
...
//                        EffectSkillService.gI().sendPlayerToCaiBinh(playerMap, 15000);
                    ...
                    for (Mob mobMap : player.skillSpecial.mobsTaget) {
                        ...
                        double maxMobHP = mobMap.point.maxHp;
                        new Thread(() -> {
                            ...
                            while (System.currentTimeMillis() - startTime <= 11000) {
                                try {
                                    ...
                                    mobMap.point.hp -= damage;
                                    if (mobMap.point.hp < 0) {
                                        mobMap.point.hp = 0;
                                    }
                                    playerAttackMob(player, mobMap, true, false);
